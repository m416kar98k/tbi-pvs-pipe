...
for i in range(num_steps):
    batch = randint(key, (1, batch_size), 0, len(iris) - 1)
    batch_feature, batch_label = feature[batch], label[batch]
    loss, grads = value_and_grad(nn_decision_tree_cross_entropy)(batch_feature, batch_label, cut_points_list, leaf_score)
